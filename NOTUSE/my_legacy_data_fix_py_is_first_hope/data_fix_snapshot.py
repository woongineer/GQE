...
if __name__ == '__main__':
    ...
    plot_result(fidelity_history, 'data_fix_snapshot_fidelity', 'data_fix_snapshot_fidelity.png')
    plot_result(loss_history, 'data_fix_snapshot_loss', 'data_fix_snapshot_loss.png')